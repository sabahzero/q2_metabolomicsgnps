...
This is a Qiime2 plugin and example tutorial for analyzing metabolomics data via [GNPS](https://gnps.ucsd.edu/ProteoSAFe/static/gnps-splash.jsp).
...
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C. Download Cross-Sectional and Longitudinal Data
...
If the installation was unsuccessful, then try the following (while in conda environment):
...
Now test and view your plugin commands:

`qiime metabolomicsgnps`

#### MS2 GNPS Clustering Commands
...
This is an example dataset containing cross sectional data from plant or animal sources. We will download it (metabolomics data) for use with the metabolomicsgnps plugin for QIIME 2. 
...
### Longitudinal Data
This is an example dataset containing longitudinal data on the fermentation process of milk to yogurt. We will download it (metabolomics data) for use with the metabolomicsgnps plugin for QIIME 2.
